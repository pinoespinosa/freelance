...
#		print('Escaneado ... ' +url+ str(pag))
		...
		existencias = daatoss.split('var colors = ')[1].split(';')[0];
		datosCategoria = '****' + datosCategoria[2].text.strip() + '___' + datosCategoria[3].text.strip() + '___' + datosCategoria[4].text.strip()
...
def escanearProducto(url):
	...
	listaResultados.append( '"' + codSKU + '";"' + departamento + '";"' + genero + '";"' + categoria + '";"' + url.split('****')[0]  + '";"' + nombre + '";"' + ','.join(listaTall) + '";"' + descripcion + '";"' + 'Link Ficha Tecnica' +  '";');
