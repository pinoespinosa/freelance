...
<form action="webscrapper.php" method="post" enctype="multipart/form-data"  >   
    <input type="submit" value="Start scan gsmarena" name="submit1" style="width: 250px;" ><br>
    <input type="submit" value="Start scan phonearena -- > Done" name="submit2" style="width: 250px;" ><br>
    <input type="submit" value="Start scan devicespecifications" name="submit3" style="width: 250px;" ><br>
    <input type="submit" value="Start scan whistleout" name="submit4" style="width: 250px;">
