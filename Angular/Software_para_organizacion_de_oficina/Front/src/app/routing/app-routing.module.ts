...
const routes: Routes = [
	...
	{ path: 'register-all',  		component: RegisterAllComponent, 		data: {title: 'Home'}, canActivate: [AuthGuard]},
	...
	{ path: 'audits',  				component: AuditsComponent, 			data: {title: 'Home'}, canActivate: [AuthGuard]},
