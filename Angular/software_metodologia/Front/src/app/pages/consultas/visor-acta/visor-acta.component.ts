...
@Component({
  selector: 'visor-acta',
  templateUrl: 'visor-acta.component.html',
  animations: [
  ],
})

export class VisorActaComponent implements OnInit  {
    ...
    let sub = this.route
      ...
      .subscribe(
        ...
        result => {
          ...
          if(result['actaID'])
            this.selectActa2(result['actaID'])
        }
  ...
  selectActa2(actaaa):void{
      ...
      let loading = this.service.getTemasConsulta2(actaaa).subscribe(
          response =>{ 
