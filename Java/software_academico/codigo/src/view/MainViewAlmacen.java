	...
	private void initialize() {
		...
		list_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				fProveedor.setText(list_1.getSelectedValue().getArticulo().getProveedor()+"");
		...
		list.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				fProveedor.setText(list.getSelectedValue().getNombre());
			}
		});
		...
		btnEditarProveedor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				it.getArticulo().setProveedor(list.getSelectedValue().getNombre());
