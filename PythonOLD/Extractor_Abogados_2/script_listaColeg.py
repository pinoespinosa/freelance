...
def descargarCategorias(codigo):
	...
	pagina2 = descargarResultadoData('http://www.coamalaga.es/colegio/quienessomos/colegiados/colegiados.asp?Apellidos=&Localidad='+codigo+'&TipoBusqueda=1&rnd=0.5768493866276709', 360, 10, payload, headers)
	...
	for pagina in pagina2:
		...
		if (matri):
			...
			saveFile('resultadosFinal_Colegiados.csv', finales)
